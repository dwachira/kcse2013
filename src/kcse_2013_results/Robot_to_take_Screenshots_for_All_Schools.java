...
public class Robot_to_take_Screenshots_for_All_Schools 
{
...
public void Robot_to_take_Screenshots_for_All_Schools() 
{
      try
      {
            FileReader KCSE_FileReader = new FileReader("C:\\Users\\Wachira\\Documents\\Netbeans_7_point_4_Projects\\KCSE_2013_Results\\DB@254.txt");
       ...
       {  
           System.out.println("Error inside Robot_to_take_Screenshots_for_All_Schools() ---> " + ex_robot); 
       }     
}
...
public void Create_Directory_With_Non_Existent_Parent_Directory ()
  {
        File file = new File("./Robot - All Candidates");
        boolean b = false;
        if (!file.exists()) 
        {
            b = file.mkdirs();
        ...
        if (b)
            System.out.println("Directory ---> "+ "./Robot - All Candidates" + " <---- successfully created");
        else
            System.out.println("Failed to create directory  ---> "+ "./Robot - All Candidates" + " <---- ");
  }
...
{   try 
     {
       ...
       File file_Text_File = new File("./Robot - All Candidates/kcse_2013_candidates.txt");
    ...
    try 
       {    
            ...
            FileReader KCSE_Results_Student_Details_FileReader = new FileReader("C:\\Users\\Wachira\\Documents\\Netbeans_7_point_4_Projects\\KCSE_2013_Results\\DB@254.txt");
...
public void Bar_Chart_Candidates_Performance() throws InterruptedException 
{                                                                     
        ...
        ary_dataset_bar_chart[0][0] = Subject_I;
        ary_dataset_bar_chart[1][0] = Subject_II;
        ary_dataset_bar_chart[2][0] = Subject_III;
        ary_dataset_bar_chart[3][0] = Subject_IV;
        ary_dataset_bar_chart[4][0] = Subject_V;
        ary_dataset_bar_chart[5][0] = Subject_VI;
        ary_dataset_bar_chart[6][0] = Subject_VII;
        ary_dataset_bar_chart[7][0] = Subject_VIII;
        
        ary_dataset_bar_chart[0][1] = Subject_I_Grade;
        ary_dataset_bar_chart[1][1] = Subject_II_Grade;
        ary_dataset_bar_chart[2][1] = Subject_III_Grade;
        ary_dataset_bar_chart[3][1] = Subject_IV_Grade;
        ary_dataset_bar_chart[4][1] = Subject_V_Grade;
        ary_dataset_bar_chart[5][1] = Subject_VI_Grade;
        ary_dataset_bar_chart[6][1] = Subject_VII_Grade;
        ary_dataset_bar_chart[7][1] = Subject_VIII_Grade;
        
        
        
        final KCSE_2013_Bar_Chart KCSE_2013_bar_chart = new KCSE_2013_Bar_Chart("KCSE 2013 Results - "+ Student_full_name, "KCSE 2013 Results - "+ Student_full_name+" ("+ KNEC_Candidate_s_index_number +")", ary_dataset_bar_chart);
        ...
        WindowFocusListener windowFocusListener = new WindowFocusListener()
        {
            ...
            {   
                ...
                System.out.println("Bar_Chart_KCSE_pie_chart - windowGainedFocus()");
                 ...
                 Bar_Chart_fileName = Bar_Chart_fileName + "Candidate's KCSE 2013 Results - "+ Student_full_name+"("+ KNEC_Candidate_s_index_number +")" + " - " + Bar_Chart_date_time_of_screenshot +" by David Wachira.png";
...
/* **************************************************************************************************************** */
        ...
        KCSE_2013_bar_chart.setSize(width,height);
    ...
    {
        Robot_to_take_Screenshots_for_All_Schools robot_kcse = new Robot_to_take_Screenshots_for_All_Schools();
        robot_kcse.Robot_to_take_Screenshots_for_All_Schools();
